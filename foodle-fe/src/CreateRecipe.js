...
export default function Recipes() {
	...
	function create() {
		setShow(false);
		if (recipeName.length === 0 || recipeImageUrl.length === 0 || recipeDescription.length === 0 || recipeCategoryId.length === 0) {
	...
	function fetchCreate(json) {
		...
		fetch("http://localhost:5164/api/categories/16/recipes", requestOptions).then((res) => afterFetchCreate(res));
	}
	...
	return (
		<>
			...
			<div className="hero-image">
				<p className="hero-text">Create new recipe</p>
			</div>
			{/* --- Recipes --- */}
			...
			<Modal show={show} onHide={handleClose}>
				...
				<Modal.Body>Are you sure you want to create a new recipe?</Modal.Body>
				<Modal.Footer>
